...
public class HomePageTest extends TestBase {
	...
	public void barChartJobOpeningToolTipTest() {
		...
		Assert.assertEquals(
				toolTipText,
				"Number of job openings for entry-level roles (<2 years of experience) in 2015, based on online job postings and ONS vacancy data");
	}
	...
	public void bubbleChartSalaryToolTipTest() {
		...
		Assert.assertEquals(salaryToolTip,
				"Average salary advertised for entry-level roles (<2 years of experience) in 2015");
	}
	...
	public void bubbleChartOpportunityToolTipTest() {
		...
		Assert.assertEquals(
				opportunityToolTip,
				"Level of opportunity facing recent course completers, measured in terms of openings relative to recent completers. Occupations with higher opportunity scores are occupations where course completers face less competition.");
	}
	...
	public void barChartTitleTest() {
		...
		Assert.assertEquals(barChartTitle,
				"Which associate professional & technical occupations have the most openings?");
	}
