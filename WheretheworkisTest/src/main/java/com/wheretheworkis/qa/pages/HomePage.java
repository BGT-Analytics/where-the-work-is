...
public class HomePage extends TestBase {
	...
	public String validateBarChartSelectedOccupationMouseHover() {
		driver.navigate().to(prop.getProperty("url"));
		dashboardOccupationGroup.click();
		testUtil.waitForElementToBeVisible(
				getChartsElementCss(barChartSelectedOccupationGroupData, barChartElementCss), 10);
	...
	public String validateBubbleChartSelectedOccupationMouseHover() {
		...
		dashboardOccupationGroup.click();
		testUtil.waitForElementToBeVisible(
				getChartsElementCss(bubbleChartOccupationData, bubbleChartSelectedElementCss), 10);
	 ...
	 * String barChatCss =
	 * "#"+highChartValue+" "+"> svg > g.highcharts-series-group > " +
	...
	public OccupationPopupWindow clickOnOccupation() {
		dashboardOccupationGroup.click();
		testUtil.waitForElementToBeVisible(
				getChartsElementCss(barChartSelectedOccupationGroupData, barChartElementCss), 20);
		if (getChartsElementCss(barChartSelectedOccupationGroupData, barChartElementCss).isDisplayed()) {
			getChartsElementCss(barChartSelectedOccupationGroupData, barChartElementCss).click();
		} else {
			try {
				Thread.sleep(5000);
